...
const ChatSupport = () => {
  ...
  const handleSendMessage = async (e) => {
    ...
    try {
      // Prepare messages for OpenAI format (only recent history for token efficiency)
      ...
      const errorMessage = {
        id: messages.length + 2,
        type: 'bot',
        text: "I'm having trouble connecting to my brain right now. Please try again or contact support if the issue persists.",
        timestamp: new Date().toISOString()
      };
